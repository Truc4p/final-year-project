...
const budgetRoutes = require("./routes/finance/budgetRoutes");
const approvalRoutes = require("./routes/finance/approvalRoutes");
const reportRoutes = require("./routes/finance/reportRoutes");
const taxRoutes = require("./routes/finance/taxRoutes");
const paymentManagementRoutes = require("./routes/finance/paymentRoutes");
const auditComplianceRoutes = require("./routes/finance/auditRoutes");
const reconciliationRoutes = require("./routes/finance/reconciliationRoutes");
const fixedAssetRoutes = require("./routes/finance/fixedAssetRoutes");
const forecastRoutes = require("./routes/finance/forecastRoutes");
...
app.use("/api/finance/approvals", approvalRoutes);
app.use("/api/finance/reports", reportRoutes);
app.use("/api/finance/tax", taxRoutes);
app.use("/api/finance/payments", paymentManagementRoutes);
app.use("/api/finance/audit", auditComplianceRoutes);
app.use("/api/finance/reconciliation", reconciliationRoutes);
app.use("/api/finance/fixed-assets", fixedAssetRoutes);
app.use("/api/finance/forecasts", forecastRoutes);
