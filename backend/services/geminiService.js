    ...
    async initialize() {
        ...
        try {
            ...
            this.model = this.genAI.getGenerativeModel({ 
                model: 'gemini-2.5-flash-lite', // Supports multimodal including audio
                generationConfig: {
    ...
    async transcribeAudio(audioFilePath) {
        ...
        try {
            ...
            const model = this.genAI.getGenerativeModel({ 
                model: 'gemini-2.5-flash-lite' // Supports audio transcription
            });
...
`;
            ...
            const visionModel = this.genAI.getGenerativeModel({ 
                model: 'gemini-2.5-flash-lite', // Supports vision input
                generationConfig: {
                    temperature: 0.7,
                    topP: 0.9,
                    topK: 40,
