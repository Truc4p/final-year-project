...
def create_drawio_xml():
    ...
    style_db = "html=1;dashed=0;whitespace=wrap;fillColor=#438DD5;strokeColor=#3C7FC0;fontColor=#ffffff;shape=mxgraph.c4.database;align=center;metaEdit=1;resizable=0;"
    ...
    # 2. System Boundary (Internet Banking System)
    # Using a group/container for the boundary
    ...
    spa = ET.SubElement(root, 'mxCell', id="spa", value=spa_val, style=style_container, parent="boundary", vertex="1")
    ...
    mobile = ET.SubElement(root, 'mxCell', id="mobile", value=mobile_val, style=style_container, parent="boundary", vertex="1")
    ...
    # Email -> Customer
    # Creating a curved line going back to customer
