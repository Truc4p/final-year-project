...
```
╔═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
║                                         WRENCOS E-COMMERCE PLATFORM                                               ║
║                            Full-Stack Beauty Business Management System                                           ║
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
...
├─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                                                 │
│   👤 CUSTOMERS                        👔 BUSINESS ADMIN/STAFF                    🌐 EXTERNAL SYSTEMS           │
│   • Browse products                   • Manage product catalog                   ┌──────────────────────┐      │
│   • Search & filter                   • View analytics dashboards                │  Google Gemini API   │      │
│   • AI chat assistance                • Configure email campaigns                │  (AI Intelligence)   │      │
│   • Watch live streams                • Conduct live streams                     └──────────────────────┘      │
│   • Participate in chat               • Respond to customer chats                                              │
│   • Add to cart & checkout            • Manage orders & inventory                ┌──────────────────────┐      │
│   • Track order status                • Track finances & cash flow               │   VNPay Gateway      │      │
│   • Subscribe to newsletter           • Manage HR & employees                    │  (Payment Process)   │      │
│   • Receive recommendations           • Send targeted marketing                  └──────────────────────┘      │
│                                       • Pin products in livestream                                              │
│                                                                                   ┌──────────────────────┐      │
│                                                                                   │   SMTP Server        │      │
│                                                                                   │  (Email Delivery)    │      │
│                                                                                   │  Gmail/SendGrid      │      │
...
│                                                                                                                 │
│  ┌────────────────────────────────┐        ┌────────────────────────────────┐       ┌──────────────────────┐  │
│  │     WEB APPLICATION            │        │    MOBILE APP (Customer)       │       │   ADMIN DASHBOARD    │  │
│  │     (Vue.js 3 + Vite)          │        │    (React Native + Expo)       │       │   (Vue.js 3)         │  │
│  ├────────────────────────────────┤        ├────────────────────────────────┤       ├──────────────────────┤  │
│  │ • Customer product browsing    │        │ • Product browsing & search    │       │ • Product CRUD       │  │
│  │ • Shopping cart                │        │ • Shopping cart & checkout     │       │ • Category mgmt.     │  │
│  │ • Live stream viewing          │        │ • Live stream viewing          │       │ • Order management   │  │
│  │ • AI chat interface            │        │ • AI chat assistance           │       │ • Analytics reports  │  │
│  │ • Order tracking               │        │ • Order tracking               │       │ • Email campaigns    │  │
│  │ • Newsletter subscription      │        │ • Push notifications           │       │ • Live streaming     │  │
│  │ • Tailwind CSS styling         │        │ • AsyncStorage (offline)       │       │ • Finance tracking   │  │
│  │ • Chart.js analytics           │        │ • React Navigation             │       │ • HR management      │  │
│  │ • Vue Router (SPA)             │        │ • Expo Image Picker            │       │ • Chat monitoring    │  │
│  │ • Vue I18n (multi-language)    │        │ • Vector Icons                 │       │ • Template editor    │  │
│  └────────────────────────────────┘        └────────────────────────────────┘       └──────────────────────┘  │
│           │                                            │                                      │                │
│           └────────────────────────────────────────────┼──────────────────────────────────────┘                │
│                                                        │                                                        │
...
│  ├──────────────────────────────────────────────────────────────────────────────────────────────────────────┤  │
│  │  • JWT Authentication (jsonwebtoken)      • Rate Limiting (express-rate-limit: 1000 req/15min)           │  │
│  │  • CORS (cors)                            • Request Validation (express-validator)                        │  │
│  │  • Body Parsing (body-parser)             • File Upload (multer)                                          │  │
│  │  • Role-Based Access Control              • Request Logging (morgan)                                      │  │
│  │  • Swagger API Documentation              • Error Handling & Response Formatting                         │  │
│  └──────────────────────────────────────────────────────────────────────────────────────────────────────────┘  │
│                                                                                                                 │
│  ┌──────────────────────────────────────────────────────────────────────────────────────────────────────────┐  │
...
│  │                                                                                                            │  │
│  │  ┌─────────────────────┐  ┌─────────────────────┐  ┌─────────────────────┐  ┌─────────────────────────┐ │  │
│  │  │  🛍️ E-COMMERCE       │  │  📺 LIVE STREAMING  │  │  💬 COMMUNICATION   │  │  📧 MARKETING           │ │  │
│  │  │  SERVICE            │  │  SERVICE            │  │  SERVICE            │  │  SERVICE                │ │  │
│  │  ├─────────────────────┤  ├─────────────────────┤  ├─────────────────────┤  ├─────────────────────────┤ │  │
│  │  │ • Product CRUD      │  │ • Stream management │  │ • AI Chat (Gemini)  │  │ • Email campaigns       │ │  │
│  │  │ • Category mgmt.    │  │ • WebSocket server  │  │ • FAQ management    │  │ • Template designer     │ │  │
│  │  │ • Shopping cart     │  │ • Real-time chat    │  │ • Staff escalation  │  │ • Subscriber segments   │ │  │
│  │  │ • Order processing  │  │ • Product pinning   │  │ • Conversation logs │  │ • Campaign analytics    │ │  │
│  │  │ • VNPay integration │  │ • Viewer tracking   │  │ • Product search    │  │ • Newsletter subscr.    │ │  │
│  │  │ • Inventory mgmt.   │  │ • Like system       │  │ • Context-aware AI  │  │ • Nodemailer SMTP       │ │  │
│  │  │ • Product search    │  │ • Stream recording  │  │ • Semantic matching │  │ • Bulk email sender     │ │  │
│  │  └─────────────────────┘  └─────────────────────┘  └─────────────────────┘  └─────────────────────────┘ │  │
│  │                                                                                                            │  │
│  │  ┌─────────────────────┐  ┌─────────────────────┐  ┌─────────────────────┐  ┌─────────────────────────┐ │  │
│  │  │  📊 ANALYTICS       │  │  💰 FINANCE         │  │  👥 HR MANAGEMENT   │  │  🔐 AUTH SERVICE        │ │  │
│  │  │  SERVICE            │  │  SERVICE            │  │  SERVICE            │  │                         │ │  │
│  │  ├─────────────────────┤  ├─────────────────────┤  ├─────────────────────┤  ├─────────────────────────┤ │  │
│  │  │ • Sales reports     │  │ • Expense tracking  │  │ • Employee records  │  │ • User registration     │ │  │
│  │  │ • Revenue metrics   │  │ • Cash flow logs    │  │ • Department mgmt.  │  │ • Login/logout          │ │  │
│  │  │ • Product perf.     │  │ • P&L statements    │  │ • Document storage  │  │ • JWT generation        │ │  │
│  │  │ • Customer insights │  │ • Category tracking │  │ • Salary tracking   │  │ • Password hashing      │ │  │
│  │  │ • Email analytics   │  │ • Recurring expenses│  │ • Staff permissions │  │ • Role management       │ │  │
│  │  │ • Chart.js reports  │  │ • Balance calc.     │  │ • Employment status │  │ • Token verification    │ │  │
│  │  └─────────────────────┘  └─────────────────────┘  └─────────────────────┘  └─────────────────────────┘ │  │
│  │                                                                                                            │  │
│  └──────────────────────────────────────────────────────────────────────────────────────────────────────────┘  │
│                                                                                                                 │
...
│  │  • Bidirectional real-time messaging            • Connection pooling (customer/admin)                    │  │
│  │  • Live stream chat broadcasting                • Viewer count synchronization                           │  │
│  │  • Customer support chat                        • Like/unlike real-time updates                          │  │
│  │  • Admin notification system                    • Pinned products broadcasting                           │  │
│  │  • Session-based tracking                       • WebRTC signaling (peer-to-peer streaming)              │  │
│  └──────────────────────────────────────────────────────────────────────────────────────────────────────────┘  │
│                                                                                                                 │
└────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
                                                         │
...
│                                                                                                                 │
│  ┌──────────────────────────────────────────────────────────────────────────────────────────────────────────┐  │
│  │                         💾 MongoDB Atlas Database (Cloud-Hosted NoSQL)                                   │  │
│  ├──────────────────────────────────────────────────────────────────────────────────────────────────────────┤  │
│  │                                     Mongoose ODM (Schema Validation)                                      │  │
│  ├──────────────────────────────────────────────────────────────────────────────────────────────────────────┤  │
│  │                                                                                                            │  │
│  │  📂 Collections:                                                                                          │  │
│  │  • users (auth, roles, profiles)              • livestreams (videos, chats, viewers)                     │  │
│  │  • products (catalog, inventory)              • chatconversations (AI, staff, history)                   │  │
│  │  • categories (product taxonomy)              • faqs (predefined Q&A)                                     │  │
│  │  • orders (transactions, status)              • emailcampaigns (marketing automation)                    │  │
│  │  • employees (HR records)                     • emailtemplates (reusable designs)                        │  │
│  │  • cashflowtransactions (finance)             • emailsegments (audience targeting)                       │  │
│  │  • businessexpenses (accounting)              • newslettersubscriptions (opt-ins)                        │  │
│  │  • emailanalytics (campaign tracking)         • sessions (cart persistence)                              │  │
│  │                                                                                                            │  │
│  │  🔍 Indexes: Text search, compound queries, unique constraints                                           │  │
│  │  🔒 Security: Encrypted connections, authentication, role-based access                                   │  │
│  │  📊 Features: Aggregation pipelines, full-text search, geospatial queries                                │  │
│  └──────────────────────────────────────────────────────────────────────────────────────────────────────────┘  │
│                                                                                                                 │
└─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
├─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                                                 │
│  1️⃣ CUSTOMER SHOPPING JOURNEY:                                                                                 │
│     Customer → Web/Mobile → Browse Products → AI Chat (Gemini recommendations) → Add to Cart → Checkout        │
│     → VNPay Payment → Order Confirmation → Email Notification (Nodemailer) → Order Tracking                    │
│                                                                                                                 │
│  2️⃣ LIVE STREAMING WORKFLOW:                                                                                   │
│     Admin → Create Stream → Start Broadcast (WebSocket) → Pin Products → Real-time Chat                        │
│     → Customer Views (WebRTC/Stream URL) → Chat Participation → Like Stream → Purchase Pinned Items            │
│     → Stream Recording → Analytics Dashboard                                                                   │
│                                                                                                                 │
│  3️⃣ AI CHAT ASSISTANCE:                                                                                        │
│     Customer → Ask Question → Chat Service → FAQ Search (MongoDB) → Product Search (MongoDB)                   │
│     → Gemini API (context + history) → AI Response + Product Links → Save Conversation                         │
│     → Optional: Escalate to Staff (WebSocket notification) → Staff Reply (real-time)                           │
│                                                                                                                 │
│  4️⃣ EMAIL MARKETING CAMPAIGN:                                                                                  │
│     Admin → Create Campaign → Select Template → Define Segment → Schedule Send                                 │
│     → Bulk Email (Nodemailer) → Track Opens/Clicks → Analytics Dashboard → Unsubscribe Handling               │
│                                                                                                                 │
│  5️⃣ ANALYTICS & REPORTING:                                                                                     │
│     All Services → MongoDB → Aggregation Queries → Analytics Service → Chart.js Visualizations                 │
│     → Admin Dashboard (Sales, Revenue, Customer Insights, Email Performance)                                   │
│                                                                                                                 │
└─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
├─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                                                 │
│  Backend: Node.js, Express.js, WebSocket (ws), JWT, bcryptjs, Mongoose, Axios, Multer, Nodemailer, node-cron  │
│  Frontend: Vue.js 3, Vite, Vue Router, Tailwind CSS, Chart.js, Vue I18n, Axios                                 │
│  Mobile: React Native 0.73.6, Expo 50.0, React Navigation, AsyncStorage, Axios, Vector Icons                   │
│  Database: MongoDB Atlas 8.0+, Mongoose ODM                                                                     │
│  AI: Google Gemini API (@google/generative-ai 0.24.1) - Model: gemini-2.0-flash                                │
│  Payments: VNPay Gateway Integration                                                                           │
│  Email: Nodemailer 7.0.9 (SMTP - Gmail/SendGrid)                                                               │
│  Dev Tools: Swagger/OpenAPI, Postman, Git/GitHub, dotenv, morgan                                               │
│  Security: JWT tokens, bcrypt hashing, CORS, rate limiting, input validation, HTTPS/TLS                        │
│                                                                                                                 │
└─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
├─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                                                 │
│  ✅ OPERATIONAL CONSOLIDATION: Unified e-commerce, marketing, analytics, finance, HR (8 services in 1 platform)│
│  ✅ PERSONALIZED ENGAGEMENT: AI product recommendations based on skin type/concerns + live shopping experience  │
│  ✅ DATA-DRIVEN INSIGHTS: Consolidated analytics dashboards (sales, customers, email, products)                │
│  ✅ REAL-TIME INTERACTION: WebSocket-powered live streaming, chat, notifications (low latency <5s)             │
│  ✅ SCALABLE ARCHITECTURE: Stateless REST API, MongoDB horizontal scaling, cloud-native design                 │
│  ✅ MULTI-PLATFORM ACCESS: Web (Vue.js), Mobile (React Native), Admin Dashboard - single codebase backend      │
│                                                                                                                 │
└─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
```
...
│  │ subject                                                            │     │
│  │ content, htmlContent                                               │     │
│  │ type (enum: newsletter/promotion/announcement/welcome/etc)         │     │
│  │ status (enum: draft/scheduled/sending/sent/paused/cancelled)       │     │
│  │ targetAudience (enum: all/segment/custom)                          │     │
│  │ segmentCriteria (object)                                           │     │
│  │   ├─ subscriptionDateFrom/To                                       │     │
│  │   ├─ sources[]                                                     │     │
│  │   ├─ preferences (object)                                          │     │
│  │   └─ customEmails[]                                               │     │
│  │ scheduledAt, sentAt                                               │     │
│  │ analytics (embedded object)                                        │     │
│  │   ├─ totalRecipients, emailsSent, emailsDelivered, emailsBounced │     │
│  │   ├─ emailsOpened, uniqueOpens, emailsClicked, uniqueClicks      │     │
...
│  ├──────────────────────────────────────────────────┤                       │
│  │ _id (PK)                                         │                       │
│  │ campaignId (FK → EmailCampaign)                 │                       │
│  │ subscriberEmail, subscriberId (FK)              │                       │
│  │ sentAt, deliveredAt, bouncedAt                  │                       │
│  │ bounceReason                                     │                       │
│  │ opens[] (embedded array)                         │                       │
│  │   ├─ timestamp, ipAddress, userAgent            │                       │
│  │   └─ location (country, city, region)           │                       │
│  │ clicks[] (embedded array)                        │                       │
│  │   ├─ timestamp, url, ipAddress, userAgent       │                       │
│  │   └─ location (country, city, region)           │                       │
│  │ unsubscribedAt, complainedAt, forwardedAt       │                       │
│  │ status (enum: sent/delivered/opened/clicked)    │                       │
│  │ deviceInfo (device type, OS, email client)      │                       │
│  │ createdAt, updatedAt                             │                       │
│  └────────────────────────────────────────────────┘                        │
│                                                                              │
│  ┌────────────────────────────────────────────────────────────────┐        │
...
│  │ preferences (object)                                            │        │
│  │   └─ newProducts, promotions, newsletter (boolean flags)       │        │
│  │ createdAt, updatedAt                                           │        │
│  └────────────────────────────────────────────────────────────────┘        │
│                                                                              │
└──────────────────────────────────────────────────────────────────────────────┘
...
**MARKETING SERVICE - Field Explanations:**

| Entity | Field | Type | Purpose |
|---|---|---|---|
| **EmailCampaign** | createdBy | FK→User | Admin who created the campaign (not "creatorId") |
| **EmailCampaign** | type | String enum | Newsletter, promotion, announcement, welcome, product_launch, abandoned_cart |
| **EmailCampaign** | status | String enum | draft, scheduled, sending, sent, paused, cancelled |
| **EmailCampaign** | targetAudience | String enum | all, segment, or custom targeting |
| **EmailCampaign** | segmentCriteria | Object | Contains subscription date range, sources, preferences filters, custom emails |
| **EmailCampaign** | analytics | Embedded object | Aggregated campaign metrics (sent, delivered, opened, clicked, bounced, unsubscribes) |
| **EmailAnalytics** | campaignId | FK→EmailCampaign | Reference to parent campaign |
| **EmailAnalytics** | subscriberEmail | String | Email address of recipient |
| **EmailAnalytics** | opens[] | Embedded array | Array of open events with timestamp, location, device info |
| **EmailAnalytics** | clicks[] | Embedded array | Array of click events with URL and engagement tracking |
| **EmailAnalytics** | status | String enum | Tracks current status: sent, delivered, opened, clicked, bounced, unsubscribed, complained |
| **NewsletterSubscription** | email | String | Subscriber email address |
| **NewsletterSubscription** | userId | FK→User | Optional reference to User account (nullable for anonymous subscribers) |
| **NewsletterSubscription** | isActive | Boolean | Whether subscription is currently active |
| **NewsletterSubscription** | preferences | Object | Subscriber communication preferences (which types of emails they want) |
