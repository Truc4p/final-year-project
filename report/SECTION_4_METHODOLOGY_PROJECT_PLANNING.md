...
This project adopted the Agile Scrum methodology for its suitability to full-stack development. This approach enabled iterative development and incremental delivery, allowing for adaptive planning and effective risk mitigation through 2-week sprint cycles.

**Scrum Framework Implementation:** The Scrum process begins by establishing a high-level Vision and User Stories, which form the prioritized Product Backlog. From this master list, specific tasks are selected during Sprint Planning to be completed within each 2-week sprint. Development was guided by daily standups (self-directed progress tracking: What did I do yesterday? What will I do today? Any Blockers?) to track progress and identify blockers. Each sprint iteration resulted in a functional software Increment, which was then evaluated during Sprint Reviews and Retrospectives (What went well? What went wrong? Action Plan for next Sprint). Sprint reviews and retrospectives were hosted by the project supervisor to evaluate feature completeness, provide technical guidance, and assess alignment with project objectives, enabling regular checkpoint validation while maintaining development momentum. This systematic delivery of functional increments incorporated continuous feedback from supervisor reviews and user validation sessions, requiring frequent integration testing and user input to cycle stakeholder feedback and process improvements back into the backlog for future development.
