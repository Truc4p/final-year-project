...
| Feature / Aspect | Shopify | Adobe Commerce | Sephora Platform | Wrencos (Proposed) |
|---|---|---|---|---|
...
| **Live Streaming Commerce** | Third-party integrations only | Limited native support | Integrated livestream shopping | Native WebSocket-based livestream; admin can broadcast via web and mobile; customers can view on web and mobile |
...
| **Skincare Consultation** | None | None | Sephora Virtual Artist (makeup only) | AI dermatology expert with text, voice, image analysis, and live chat; RAG over curated dermatology literature/textbooks with citations |
| **Multi-Platform Support** | Web only | Web only | Web + iOS/Android mobile | Web (admin/customer) + iOS/Android mobile (customer/admin) |
