...
**Synthesis of Findings:** The literature review reveals three critical findings: beauty e-commerce demonstrates sustained growth yet SMEs face USD 500–3,000 monthly costs managing 5–8 disconnected platforms whilst consumers experience 40%+ returns from sensory deficits; competitive analysis shows Shopify requires costly third-party integrations, Adobe Commerce overspecifies SME needs with prohibitive costs, and Sephora serves only consumers—critically, no platform integrates native livestreaming with AI dermatology consultation; technology review confirms feasibility through Node.js/Express (5× higher throughput), Vue.js (50% smaller bundles), MongoDB (schema flexibility), and Qdrant (sub-millisecond RAG search).

**Research Gap:** In summary, the literature review identifies a clear gap: there is no single, SME-accessible platform that combines comprehensive e-commerce functionality with native livestreaming across web and mobile, AI-powered dermatology consultation featuring text/voice interaction and RAG-based cited guidance, and integrated business management within one modern architecture. Existing solutions are either too fragmented requiring expensive third-party aggregation (Shopify), overspecified for SME budgets (Adobe Commerce), or proprietary consumer ecosystems inaccessible to independent retailers (Sephora).

**Project Positioning:** Therefore, this project addresses this gap by developing Wrencos, an integrated cross-platform ecosystem using Node.js/Express, Vue.js, and React Native that delivers three unique value propositions: (1) unified backend eliminating fragmentation whilst enabling cross-module personalization across e-commerce, livestreaming, AI chat, email marketing, analytics, accounting, and HR; (2) native WebSocket livestreaming with real-time engagement complemented by Google Gemini AI providing context-aware skin-type recommendations; (3) Skin Study dermatology module implementing RAG with Qdrant supporting text/voice chat, image analysis, and citation-backed guidance under 200ms latency—directly addressing SME operational costs and consumer trust barriers at accessible pricing.
