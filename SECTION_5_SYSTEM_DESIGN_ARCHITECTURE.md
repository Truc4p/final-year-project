...
│  │   ├─ content                                              │   │
│  │   ├─ timestamp                                            │   │
│  │   ├─ messageType (text / faq / ai / staff)               │   │
│  │   └─ metadata                                             │   │
│  │      ├─ faqId (FK → FAQ)                                │   │
│  │      ├─ intent                                            │   │
│  │      ├─ confidence                                        │   │
│  │      └─ retrievedProducts[] (FK refs)                    │   │
│  │ isActive                                                  │   │
│  │ isStaffChat                                               │   │
│  │ waitingForStaff                                           │   │
...
│                                                                    │
│  Key Features:                                                    │
│  1. FAQ management (predefined Q&A lookup)                        │
│  2. AI-powered chat (integrated Google Gemini)                    │
│  3. Customer support escalation (route to staff)                  │
│                                                                    │
│  Note: No separate AI Service - AI is integrated feature          │
│                                                                    │
└────────────────────────────────────────────────────────────────────┘
```
...
│  └────────────────────────────────────────────────────────────┘   │
│                                                                    │
│  Shared FAQ collection used by Communication Service             │
│                                                                    │
└────────────────────────────────────────────────────────────────────┘
```
